...
INSERT ALL
INTO CUSTOMER(C_CODE, LNAME, FNAME, C_AREA, C_PHONE, BALANCE)
	VALUES(10010, 'Anderson', 'James', 615, 2933893, 0.00)
INTO CUSTOMER(C_CODE, LNAME, FNAME, C_AREA, C_PHONE, BALANCE)
	VALUES(10011, 'Kurtis', 'Elena', 713, 2753455, 0.00)
INTO CUSTOMER(C_CODE, LNAME, FNAME, C_AREA, C_PHONE, BALANCE)
	VALUES(10012, 'Smith', 'Kathy', 615, 2873453, 345.86)
INTO CUSTOMER(C_CODE, LNAME, FNAME, C_AREA, C_PHONE, BALANCE)
	VALUES(10013, 'Paul', 'Chris', 615, 2879998, 536.75)
INTO CUSTOMER(C_CODE, LNAME, FNAME, C_AREA, C_PHONE, BALANCE)
	VALUES(10014, 'Johnson', 'Bill', 615, 2455533, 0.00)
INTO CUSTOMER(C_CODE, LNAME, FNAME, C_AREA, C_PHONE, BALANCE)
	VALUES(10015, 'Samuels', 'Julia', 713, 2345432, 0.00)
INTO CUSTOMER(C_CODE, LNAME, FNAME, C_AREA, C_PHONE, BALANCE)
	VALUES(10016, 'Harris', 'Anne', 615, 2233445, 221.19)
INTO CUSTOMER(C_CODE, LNAME, FNAME, C_AREA, C_PHONE, BALANCE)
	VALUES(10017, 'Ford', 'Gustav', 615, 2223444, 768.93)
INTO CUSTOMER(C_CODE, LNAME, FNAME, C_AREA, C_PHONE, BALANCE)
	VALUES(10018, 'Lee', 'Ming', 713, 2323234, 216.55)
INTO CUSTOMER(C_CODE, LNAME, FNAME, C_AREA, C_PHONE, BALANCE)
	VALUES(10019, 'Green', 'Walter', 615, 2786403, 0.00)
SELECT * FROM dual;

DELETE FROM VENDOR;
INSERT ALL
INTO VENDOR(V_CODE, V_NAME, V_CONTACT, V_AREA, V_PHONE, V_STATE, V_ORDER)
	VALUES(21225, 'Bryson, Inc.', 'Bella', 615, 2453628, 'TN', 'Y')
INTO VENDOR(V_CODE, V_NAME, V_CONTACT, V_AREA, V_PHONE, V_STATE, V_ORDER)
	VALUES(21226, 'SuperLoo, Inc.', 'Ching-Hun', 904, 3876330, 'FL', 'N')
INTO VENDOR(V_CODE, V_NAME, V_CONTACT, V_AREA, V_PHONE, V_STATE, V_ORDER)
	VALUES(21231, 'GnB Supply', 'Samson', 615, 2889922, 'TN', 'Y')
INTO VENDOR(V_CODE, V_NAME, V_CONTACT, V_AREA, V_PHONE, V_STATE, V_ORDER)
	VALUES(21344, 'Gomez Sons', 'Mark', 615, 2986363, 'KY', 'N')
INTO VENDOR(V_CODE, V_NAME, V_CONTACT, V_AREA, V_PHONE, V_STATE, V_ORDER)
	VALUES(22587, 'Downing, Inc.', 'Simon Singh', 901, 3985333, 'GA', 'N')
INTO VENDOR(V_CODE, V_NAME, V_CONTACT, V_AREA, V_PHONE, V_STATE, V_ORDER)
	VALUES(23119, 'Blackman Sisters', 'Svetlana', 901, 3562429, 'GA', 'Y')
INTO VENDOR(V_CODE, V_NAME, V_CONTACT, V_AREA, V_PHONE, V_STATE, V_ORDER)
	VALUES(24004, 'Almeda House', 'Almeda', 615, 2787878, 'TN', 'N')
INTO VENDOR(V_CODE, V_NAME, V_CONTACT, V_AREA, V_PHONE, V_STATE, V_ORDER)
	VALUES(24288, 'Justin Stores', 'Gracy Yu', 615, 2543333, 'TN', 'Y')
INTO VENDOR(V_CODE, V_NAME, V_CONTACT, V_AREA, V_PHONE, V_STATE, V_ORDER)
	VALUES(25443, 'Super Systems', 'Ted Hwang', 904, 3561111, 'FL', 'N')
INTO VENDOR(V_CODE, V_NAME, V_CONTACT, V_AREA, V_PHONE, V_STATE, V_ORDER)
	VALUES(25501, 'SilverminesLtd.', 'Anne White', 615, 2983455, 'TN', 'N')
INTO VENDOR(V_CODE, V_NAME, V_CONTACT, V_AREA, V_PHONE, V_STATE, V_ORDER)
	VALUES(25595, 'HighEnd Supplies', 'Smith', 904, 3098773, 'FL', 'Y')
SELECT * FROM dual;
...
DELETE FROM PRODUCT;
INSERT ALL
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('AB112', 'Power Painter', '03-NOV-11', 8, 5, 109.99, 0.00, 25595)
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('SB725', '7.25in Saw Blade', '13-DEC-11', 32, 15, 14.99, 0.05, 21344)
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('SB900', '9.00 in Saw Blade', '13-NOV-11', 18, 12, 17.49, 0.00, 21344)
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('CL025', 'Hrd. Cloth 1/4in', '15-JAN-12', 15, 8, 39.95, 0.00, 23119)
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('CL050', 'Hrd. Cloth 1/2in', '15-JAN-12', 23, 5, 43.99, 0.00, 23119)
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('JB012', 'Jigsaw 12in Blade', '30-DEC-11', 8, 5, 109.92, 0.05, 24288)
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('JB008', 'Jigsaw 8in Blade', '24-DEC-11', 6, 5, 99.87, 0.05, 24288)
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('CD00X', 'Cordless Drill', '20-JAN-12', 12, 5, 38.95, 0.05, 25595)
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('CH10X', 'Claw Hammer', '20-JAN-12', 23, 10, 9.95, 0.10, 21225)
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('SH100', 'Sledge Hammer', '02-JAN-12', 8, 5, 14.40, 0.05, NULL)
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('RF100', 'Rat Tail File', '15-DEC-11', 43, 20, 4.99, 0.00, 21344)
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('HC100', 'Hicut Chain Saw', '07-FEB-12', 11, 5, 256.99, 0.05, 24288)
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('PP101', 'PVC Pipe', '20-FEB-12', 188, 75, 5.87, 0.00, NULL)
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('MC001', 'Metal Screw', '01-MAR-12', 172, 75, 6.99, 0.00, 21225)
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('WC025', '2.5in wide Screw', '24-FEB-12', 237, 100, 8.45, 0.00, 21231)
INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('SM48X', 'Steel Malting Mesh', '17-JAN-12', 18, 5, 119.95, 0.10, 25595)
SELECT * FROM dual;
...
INSERT INTO CUSTOMER(C_CODE, LNAME, FNAME, C_AREA, C_PHONE, BALANCE)
	VALUES(10020, 'Dawson', 'Grace', 904, 3562098, 452.99);
INSERT INTO VENDOR(V_CODE, V_NAME, V_CONTACT, V_AREA, V_PHONE, V_STATE, V_ORDER)
	VALUES(24992, 'Martha Associates', 'Jasmine Ray', 615, 2863322, 'KY', 'N');
INSERT INTO INVOICE (INV_NUM, C_CODE, INV_DATE)
	VALUES(1009, 10020, '22-JUN-13');
INSERT INTO PRODUCT (P_CODE , DESCRIPT, P_DATE, QTY, P_MIN, P_PRICE, P_DISC, V_CODE)
	VALUES('HH15X', 'Hanging Hook 15in', '10-JAN-13', 200, 25, 5.75, 0.00, 24992);
INSERT INTO LINE (INV_NUM, L_NUM, P_CODE, L_UNITS, L_PRICE)
	VALUES (1009, 1, 'HH15X', 20, 5.50);

--QUERY(6) Write the SQL code that will list P_CODE, DESCRIPT, V_CODE for all products that are some kind of blades.

SELECT P_CODE, DESCRIPT, V_CODE FROM PRODUCT WHERE DESCRIPT LIKE '%Blade';
